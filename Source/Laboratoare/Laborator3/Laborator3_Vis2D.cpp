...
{
	float dist = deltaTime * MOVEMENT_SPEED;
	...
	float zoomAmount = deltaTime * ZOOM_FACTOR;
	float deformedWidth = logicSpace.width / DEFORMATION_FACTOR;
	float deformedHeight = logicSpace.height / DEFORMATION_FACTOR;

	// ZOOM IN
	if (window->KeyHold(GLFW_KEY_Z)) {
		logicSpace.x += deformedWidth;
		logicSpace.y += deformedHeight;
